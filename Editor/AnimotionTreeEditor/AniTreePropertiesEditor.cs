...
namespace Animotion {
    public class AniTreePropertiesEditor : AnimotionEditorWindowComponent {
        ...
        public override void Draw() {
            ...
            if (animotionTreeEditor.tree) {
                ...
                for (int i = 0; i < properties.Count; i++) {
                    ...
                    Handles.DrawSolidRectangleWithOutline(propertyRect, AniTreeEditor.LIGHT_BACKGROUND_COLOR, AniTreeEditor.BORDER_COLOR);

...
namespace Animotion {
    public class AniClipEditorWindowTimeline : AnimotionEditorWindowComponent {
        ...
        public AniFrame frameDataDragged = null;
        ...
        public override void Draw() {
            ...
            Handles.color = AniClipEditorWindow.BORDER_COLOR;
            ...
            Handles.color = AniClipEditorWindow.BORDER_COLOR;
            Handles.DrawLine(timelineRect.min + new Vector2(scrollPos.x, 0), new Vector2(timelineRect.xMin, timelineRect.yMax + AniClipEditorWindow.SCROLLBAR_HORIZONTAL_HEIGHT) + new Vector2(0, scrollPos.y)); // Separation between properties and timeline
            ...
            if (animotionClip) {
                ...
                for (int i = 0; i <= Mathf.Max(animotionClip.length, animotionClip.GetFrameNumber()); i++) {
                    if (i < animotionClip.GetFrameNumber()) {
                        AniFrame frameData = animotionClip.GetFrame(i);
                        if (frameData != null) {
                            if (frameData.sprite) {
